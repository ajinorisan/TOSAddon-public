...
function goddess_icor_manager_newframe_init()
    ...
    for i = 1, #managed_list do
        ...
        -- print(tostring(size))
        -- print(tostring(item_obj.ClassID))
        -- return
        local jx = 25
        if size ~= 0 then
            for j = 1, size do
