...
-- EP17_2_KATYN_12_MQ13c
function SCR_PRE_EP17_2_KATYN_12_MQ13(self, argObj, argstring, argnum1, argnum2)
   
    if type(IsPlayingDirection) ~= "function" then
        return;
    end

  
    --연출을 보고 있으면 퀘스트 아이템을 사용하지 못한다.
    if IsPlayingDirection(self) == 1 then
        return 0
    end

    if IsPlayingMGame(self, "EP17_2_KATYN_12_MQ13_MINI") == 1 then
        return 0
    end

    --782 249 -1127
    local dis = Get2DDistFromPos(self, -780, -1127);
...
-- EP17_2_KATYN_12_MQ14
function SCR_PRE_EP17_2_KATYN_12_MQ14(self, argObj, argstring, argnum1, argnum2)
    ...
    if IsPlayingMGame(self, "EP17_2_KATYN_12_MQ14_MINI") == 1 then
        return 0
    end

    local dis = Get2DDistFromPos(self, 280, 1549);
...
-- EP17_2_KATYN_12_MQ15
function SCR_PRE_EP17_2_KATYN_12_MQ15(self, argObj, argstring, argnum1, argnum2)
    ...
    if IsPlayingMGame(self, "EP17_2_KATYN_12_MQ15_MINI") == 1 then
        return 0
    end

    local dis = Get2DDistFromPos(self, 1035, 529);
