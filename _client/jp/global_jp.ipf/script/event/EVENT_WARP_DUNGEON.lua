...
function SCR_USE_ITEM_Dungeon_Lv100(self)
    MoveZone(self, 'c_Klaipe', -270.26, 240.49, 714.71);
end
...
function SCR_USE_ITEM_Guide_Cube_1(pc) 
    ...
    local CheckList = {
        ...
        {260 ,"Premium_boostToken03", 2, "Event_Warp_Dungeon_Lv260", 1, "Event_Warp_Dungeon_Lv260_2", 1, "Hat_628032", 1},
...
function SCR_NPC_RETENTION_DIALOG(self, pc)
  ...
  local sObj = GetSessionObject(pc, 'ssn_klapeda')
	...
	if ((month == 4 and day >= 19) or month >= 5) and year == 2017 then
