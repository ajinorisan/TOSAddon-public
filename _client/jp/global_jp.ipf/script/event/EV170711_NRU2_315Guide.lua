...
--    
--    if ((month >= 9 and day >= 20) or (month >= 10)) and year >= 2017 then
--        if aObj.EV170927_JP_NRU_ALWAYS_1 < 4 then
--            if sObj.EV170927_JP_NRU_ALWAYS_2 == 0 then
--                local tx = TxBegin(pc)
--                TxGiveItem(tx, 'Event_Nru2_Box_1', 1, 'EV170711_NRU2');
--                TxSetIESProp(tx, aObj, 'EV170927_JP_NRU_ALWAYS_1', aObj.EV170927_JP_NRU_ALWAYS_1 + 1);
--                TxSetIESProp(tx, sObj, 'EV170927_JP_NRU_ALWAYS_2', sObj.EV170927_JP_NRU_ALWAYS_2 + 1);
--                local ret = TxCommit(tx)
--                SendAddOnMsg(pc, 'NOTICE_Dm_!', ScpArgMsg("steam_Nru_Always_2", "NRUCOUNT", 4 - aObj.EV170927_JP_NRU_ALWAYS_1), 5)
--             else
...
--    local tx = TxBegin(pc)
--    TxGiveItem(tx, 'Premium_boostToken_14d', 2, 'EV170711_NRU2');
...
--    local tx = TxBegin(pc)
--    TxGiveItem(tx, 'PremiumToken_1d', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Premium_WarpScroll', 5, 'EV170711_NRU2');
--    TxGiveItem(tx, 'RestartCristal', 5, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Mic', 10, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Event_drug_steam_1h', 10, 'EV170711_NRU2');
...
--    local tx = TxBegin(pc)
--    TxGiveItem(tx, 'Premium_boostToken_14d', 2, 'EV170711_NRU2');
--    TxGiveItem(tx, 'NECK99_102', 1, 'EV170711_NRU2');
...
--    local tx = TxBegin(pc)
--    TxGiveItem(tx, 'Premium_indunReset_14d', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Mic', 10, 'EV170711_NRU2');
...
--    TxGiveItem(tx, 'Premium_indunReset_14d', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Mic', 10, 'EV170711_NRU2');
--    TxGiveItem(tx, 'E_HAIR_F_117', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'E_HAIR_M_116', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'E_costume_Com_4', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'RestartCristal', 5, 'EV170711_NRU2');
...
--    TxGiveItem(tx, 'Hat_628061', 1, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Mic', 10, 'EV170711_NRU2');
--    TxGiveItem(tx, 'Premium_WarpScroll', 5, 'EV170711_NRU2');
...
--    TxGiveItem(tx, 'Premium_Enchantchip14', 3, 'EV170711_NRU2');
--    local ret = TxCommit(tx)
--end