                ...
                elseif msgType ~= "System" then
                    ...
                    elseif msgType == "Whisper" then
                        ...
                        if colorCls ~= nil then
                            fontStyle = (msgIsMine and "{#" .. colorCls.TextColor .. "}{b}{ol}{ds}") or
...
function CHATEXTENDS_BALLON_DRAW(groupboxname, groupbox, clustername, clusterinfo, commnderName, msgType, marginRight,
    ...
    if chatCtrlName == 'chati' then
        ...
        local text =
            labelBox:CreateOrGetControl("richtext", "text", 320, 20, ui.CENTER_HORZ, ui.CENTER_VERT, 0, 0, 0, 0);
        AUTO_CAST(text);
        ...
        local text =
            labelBox:CreateOrGetControl("richtext", "text", 330, 20, ui.CENTER_HORZ, ui.CENTER_VERT, 0, 0, 0, 0);
        AUTO_CAST(text);
        text:SetUseOrifaceRect(true);
        text:EnableResizeByText(1);
