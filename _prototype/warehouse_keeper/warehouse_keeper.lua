...
function warehouse_keeper_ACCOUNT_WAREHOUSE_ON_CHANGE_TAB()
    ...
    -- print(cnt)
    -- ウェアハウスのアイテムを格納するテーブル
    -- g.settings = g.settings or {} -- g.settingsがnilでないことを確認
    -- g.settings.warehouse_items = g.settings.warehouse_items or {}
    -- print("test")
    for i = 0, cnt - 1 do

        -- print(tostring(slot_index))
        ...
        if obj.ClassName ~= MONEY_NAME then
            ...
            elseif accountwarehouse_tab:GetSelectItemIndex() == 1 then
                ...
                local j = 1
                for i = g.max_count - 280 + 1, count do
            ...
            elseif accountwarehouse_tab:GetSelectItemIndex() == 2 then
                ...
                local j = 1
                for i = g.max_count - 280 + 71, count do
            ...
            elseif accountwarehouse_tab:GetSelectItemIndex() == 3 then
                ...
                local j = 1
                for i = g.max_count - 280 + 141, count do
            ...
            elseif accountwarehouse_tab:GetSelectItemIndex() == 4 then
                ...
                local j = 1
                for i = g.max_count - 280 + 211, count do
