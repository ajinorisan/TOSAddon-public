...
function BOSS_DIRECTION_ON_MSG(frame, msg, argStr, argNum)
    ...
    if handle == 0 or msg == "TARGET_CLEAR_BOSS" then
    ...
    if msg == 'TARGET_UPDATE' or msg == 'TARGET_BUFF_UPDATE' or msg == 'TARGET_BUFF_UPDATE' then
        ...
        if not stat then
            ...
            if faint_gauge and faint_gauge:IsVisible() == 1 then
                arrow:SetColorTone("FFFFD700");
            end
        end
