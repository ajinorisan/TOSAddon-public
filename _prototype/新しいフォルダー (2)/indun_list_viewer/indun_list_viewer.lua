...
function indun_list_viewer_job_slot(frame, pcname, jobid, president, x, layer, cid)
    ...
    if type(_G[functionName]) == "function" then
        ...
        jobicon:SetEventScript(ui.LBUTTONDOWN, "indun_list_viewer_INSTANTCC_DO_CC")
        jobicon:SetEventScriptArgString(ui.LBUTTONDOWN, cid)
        jobicon:SetEventScriptArgNumber(ui.LBUTTONDOWN, layer)
