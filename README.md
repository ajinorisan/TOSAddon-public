...
ヴァカリネの恩恵(5箇所)装着時、レイド等で装備を自動で脱着します。ミニマップ辺りにヴァカリネのアイコン表示されます。
...
*   v1.0.6 補助武器の挙動バグ修正。聖域とヴェルニケでも動く様に
*   v1.0.5 機能追加
...
*   v1.6.7 520のチャレンジ券買えなかったバグ修正
*   v1.6.6 セット表示切替。セット名変更機能。網掛け表示変更、フレームスキン変更機能追加。テルハルシャUSEボタンバグ修正
*   v1.6.5 2509アプデ対応。住宅ポイント表示他。魔の巣窟、テルハルシャBUYUSE、JSRの時差調整 
...
*   v1.1.6 250902大型アップデート対応。540装備対応
...
50. ボスレランキング取得表示機能
60. チャットフレームボタン拡張
61. ボスレランキング報酬1段目残す機能
62. ハードレイドの追加報酬券持っている場合にお知らせ機能
...
*   v3.0.2 設定フレーム開かないバグ修正。
*   v3.0.1 他人様のコードが読みにくかったのでリニューアル。世界樹などの時間管理機能追加。
*   v2.0.7 ニコチャット機能追加。PTチャットはうるさいかもなのでアプデ推奨
