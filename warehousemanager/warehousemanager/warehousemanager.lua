...
--[[function WarehouseManager.DepositItems(self)
    ...
    local goal_index = 0
    if WarehouseManager.slot_per_tab_left_4 < 342 then
        -- print(WarehouseManager.slot_per_tab_left_4 .. "goal")
        goal_index = WarehouseManager.slot_per_tab_left_4 + 1
        item.PutItemToWarehouse(IT_ACCOUNT_WAREHOUSE, depositItem.ItemGuid, depositItem.Count, handle, goal_index)
    elseif WarehouseManager.slot_per_tab_left_3 < 272 then
        -- print(WarehouseManager.slot_per_tab_left_3 .. "goal")
        goal_index = WarehouseManager.slot_per_tab_left_3 + 1
        item.PutItemToWarehouse(IT_ACCOUNT_WAREHOUSE, depositItem.ItemGuid, depositItem.Count, handle, goal_index)
    elseif WarehouseManager.slot_per_tab_left_2 < 202 then
        -- print(WarehouseManager.slot_per_tab_left_2 .. "goal")
        goal_index = WarehouseManager.slot_per_tab_left_2 + 1
        item.PutItemToWarehouse(IT_ACCOUNT_WAREHOUSE, depositItem.ItemGuid, depositItem.Count, handle, goal_index)
    elseif WarehouseManager.slot_per_tab_left_1 < 132 then
        -- print(WarehouseManager.slot_per_tab_left_1 .. "goal")
        goal_index = WarehouseManager.slot_per_tab_left_1 + 1
        item.PutItemToWarehouse(IT_ACCOUNT_WAREHOUSE, depositItem.ItemGuid, depositItem.Count, handle, goal_index)
    elseif WarehouseManager.slot_per_tab_left_0 < WarehouseManager.slot_per_tab_right_0 then
        -- print(WarehouseManager.slot_per_tab_left_0 .. "goal")
        goal_index = WarehouseManager.slot_per_tab_left_0 + 1
        item.PutItemToWarehouse(IT_ACCOUNT_WAREHOUSE, depositItem.ItemGuid, depositItem.Count, handle, goal_index)
    end
...
function WarehouseManager.GetArrangeItemList(self)
    ...
    for _, itemSetting in ipairs(itemList) do
        ...
        FOR_EACH_INVENTORY(invItemList, function(invItemList, invItem, invItemOpt)

            if itemSetting.ItemType == invItem.type then
                invItemOpt.ItemExist = true
            end
        end, false, invItemOpt)
    ...
    FOR_EACH_INVENTORY(warehouseItemList, function(warehouseItemList, warehouseItem)
